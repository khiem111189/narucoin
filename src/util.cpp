...
const char * const BITCOIN_CONF_FILENAME = "narucoin.conf";
const char * const BITCOIN_PID_FILENAME = "narucoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Narucoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Narucoin";
#else
    // Unix
    return pathRet / ".narucoin";
#endif
#endif
}
