...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s narucoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  narucoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded narucoin transaction") + "\n" +
              "  narucoin-tx [options] -create [commands]   " + _("Create hex-encoded narucoin transaction") + "\n" +
              "\n";
