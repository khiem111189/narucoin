...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/narucoin-project/narucoin>";
    const std::string URL_WEBSITE = "<https://narucoin.org>";
